      ...
      <div class="container-fluid">
        ...
        <div class="bg-warning py-5 rounded-5" style="background-image: url('<?php echo base_url('asset-pelanggan') ?>/images/bg-pattern-2.png') no-repeat;">
          <div class="container">
            <div class="row">
              <div class="col-md-4">
                <img src="<?php echo base_url('asset-pelanggan') ?>/images/phone.png" alt="phone" class="image-float img-fluid">
              </div>
              <div class="col-md-8">
                ...
                <div class="d-flex gap-2 flex-wrap">
                  <img src="<?php echo base_url('asset-pelanggan') ?>/images/app-store.jpg" alt="app-store">
                  <img src="<?php echo base_url('asset-pelanggan') ?>/images/google-play.jpg" alt="google-play">
                </div>
              </div>
            </div>
          </div>
