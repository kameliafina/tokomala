...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo base_url('asset-pelanggan') ?>/css/vendor.css">
    <link rel="stylesheet" type="text/css" href="<?php echo base_url('asset-pelanggan') ?>/style.css">
  ...
  <body>
    ...
    <header style="position: sticky; top: 0; z-index: 999; background-color: white; ">
        ...
        <div class="row py-2 border-bottom">
          ...
          <div class="col-sm-8 col-lg-4 d-flex justify-content-end gap-5 align-items-center mt-4 mt-sm-0 justify-content-center justify-content-sm-end">
            <div class="support-box text-end d-none d-xl-block">
              <span class="fs-6 text-muted">Hubungi Kami</span>
              <h5 class="mb-0">+62-857-926-0099</h5>
            </div>
    ...
    <?php endif; ?>
              ...
              <li>
                <a href="<?= site_url('pelangganctrl/keranjang') ?>" class="rounded-circle bg-light p-2 mx-1">
                ...
                <div class="offcanvas-body">
                  ...
                  <ul class="navbar-nav justify-content-end menu-list list-unstyled d-flex gap-md-3 mb-0">
                    <li class="nav-item active">
                      <a href="<?= site_url('/pelangganctrl/index')?>" class="nav-link">Home</a>
                    </li>
                    <li class="nav-item">
        ...
        <div class="row">
            <div class="col-md-6 p-5">
                <div class="section-header">
                    <h2 class="section-title display-4">Kotak <span class="text-primary">Kritik</span> Saran Toko Mala</h2>
                </div>
                <p>Jika ada kritik saran yang ingin disampaikan, bisa mengisikan disini yaaa</p>
            </div>
            <div class="col-md-6 p-5">
                <form action="<?= base_url('barangctrl/simpankritik') ?>" method="post">
                    <?= csrf_field() ?>
                    <div class="mb-3">
                        <label for="nama" class="form-label">Nama</label>
                        <input type="text" class="form-control form-control-lg" name="nama" id="nama" placeholder="Nama Anda" value="<?= old('nama') ?>">
                        <?php if (session('validation') && session('validation')->hasError('nama')): ?>
                            <small class="text-danger"><?= session('validation')->getError('nama') ?></small>
                        <?php endif; ?>
                    </div>
                    <div class="mb-3">
                        <label for="deskripsi" class="form-label">Kritik Saran</label>
                        <textarea class="form-control form-control-lg" name="deskripsi" id="deskripsi" placeholder="Tulis kritik dan saran disini"><?= old('deskripsi') ?></textarea>
                        <?php if (session('validation') && session('validation')->hasError('deskripsi')): ?>
                            <small class="text-danger"><?= session('validation')->getError('deskripsi') ?></small>
                        <?php endif; ?>
                    </div>
      ...
      <div class="container-fluid">
        ...
        <div class="bg-warning py-5 rounded-5" style="background-image: url('<?php echo base_url('asset-pelanggan') ?>/images/bg-pattern-2.png') no-repeat;">
          <div class="container">
            <div class="row">
              <div class="col-md-7">
                <img src="<?php echo base_url('asset-pelanggan') ?>/images/logo2.png" alt="phone" class="image-float img-fluid">
              </div>
              <div class="col-md-8">
                <h2 class="my-5">Belanja Lebih Cepat di Toko Mala</h2>
                <p>Belanja peralatan rumah tangga kini menjadi lebih mudah dan praktis hanya di sini. Kami menyediakan berbagai macam peralatan rumah tangga berkualitas, mulai dari perlengkapan dapur, peralatan kebersihan, hingga perabotan rumah yang dapat memenuhi semua kebutuhan Anda. Temukan berbagai pilihan produk yang dapat membantu mempermudah aktivitas sehari-hari Anda, dengan harga terjangkau dan kualitas terbaik yang dijamin. Dengan layanan yang cepat dan mudah, belanja peralatan rumah tangga kini tidak perlu repot!</p>
      ...
      <div class="container-fluid">
        <div class="row">
          ...
          <div class="col-md-6 credit-link text-start text-md-end">
            <p>Tugas akhir Ecommerce <a href="https://www.instagram.com/kkaryuna?igsh=d3B3bTA3cjQxY3ly">Fina Nikmatul Kamelia</a> 22.230.0044</p>
          </div>
        </div>
      </div>
    </div>
    <script src="<?php echo base_url('asset-pelanggan') ?>/js/jquery-1.11.0.min.js"></script>
    <script src="https://cdn.jsdelivr.net/npm/swiper@9/swiper-bundle.min.js"></script>
    <script src="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0-alpha3/dist/js/bootstrap.bundle.min.js" integrity="sha384-ENjdO4Dr2bkBIFxQpeoTz1HIcje39Wm4jDKdf19U8gI4ddQ3GYNS7NTKfAdVQSZe" crossorigin="anonymous"></script>
    <script src="<?php echo base_url('asset-pelanggan') ?>/js/plugins.js"></script>
    <script src="<?php echo base_url('asset-pelanggan') ?>/js/script.js"></script>
  </body>
</html>